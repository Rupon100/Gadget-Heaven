            ...
            <div className="border flex gap-4 justify-center items-center flex-row max-w-4xl mx-auto -mt-24 bg-white p-4 rounded-md">
                ...
                <div className="w-1/3 space-y-2">
                    ...
                    <div className="flex gap-2">
                        <div className="p-2  rounded-full cursor-pointer flex justify-center items-center text-sm bg-purple-600 font-semibold text-white gap-2">
                        ...
                        <div>
                            <div className="p-2 cursor-pointer flex justify-center border rounded-full">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
